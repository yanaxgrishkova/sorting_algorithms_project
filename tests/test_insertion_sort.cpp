...
TEST_CASE("insertion_sort2", "N=10")
{
	srand(time(NULL));
	const int N = 10;
...
TEST_CASE("insertion_sort3", "N = 100")
{
	srand(time(NULL));
	const int N = 100;
...
TEST_CASE("insertion_sort4", "N=500")
{
	srand(time(NULL));
	const int N = 500;
...
TEST_CASE("insertion_sort5", "N=1000")
{
	srand(time(NULL));
	const int N = 1000;
...
TEST_CASE("insertion_sort_swap_1", "N=10")
{
	srand(time(NULL));
	const int N = 10;
...
TEST_CASE("insertion_sort_fewunique", "N=1")
{
	srand(time(NULL));
	const int N = 1;
...
TEST_CASE("insertion_sort_fewunique_2", "N=100")
{
	srand(time(NULL));
	const int N = 100;
